<script lang="ts">
	...
	import { Skull, Dices, Trophy, Slack, FolderClock, Moon, FileCog } from 'lucide-svelte';
	import { themeStore } from '$lib/stores/themeStore';
	$: iconColor = $themeStore == 'dark' ? '#ffffff' : '#000000'; // Adjust these colors as needed
</script>
		...
		<div class="grid md:grid-cols-2 gap-8 lg:gap-16">
			<div class="space-y-8 lg:space-y-12">
				...
				<div class="flex items-start">
					...
					<div class="ms-6 sm:ms-8">
						<h3 class="text-base sm:text-lg font-semibold text-green-500">Flexible Match Modes</h3>
				...
				<div class="flex items-start">
					...
					<div class="ms-6 sm:ms-8">
						<h3 class="text-base sm:text-lg font-semibold text-green-500">Competitive Leagues</h3>
						<p class="mt-1 text-gray-600 dark:text-gray-300">
				...
				<div class="flex items-start">
					...
					<div class="ms-6 sm:ms-8">
						<h3 class="text-base sm:text-lg font-semibold text-green-500">Comprehensive History</h3>
						<p class="mt-1 text-gray-600 dark:text-gray-300">
			...
			<div class="space-y-8 lg:space-y-12">
				...
				<div class="flex items-start">
					...
					<div class="ms-6 sm:ms-8">
						<h3 class="text-base sm:text-lg font-semibold text-green-500">Seamless Integrations</h3>
						<p class="mt-1 text-gray-600 dark:text-gray-300">
				...
				<div class="flex items-start">
					...
					<div class="ms-6 sm:ms-8">
						<h3 class="text-base sm:text-lg font-semibold text-green-500">Dark Mode</h3>
						<p class="mt-1 text-gray-600 dark:text-gray-300">
				...
				<div class="flex items-start">
					...
					<div class="ms-6 sm:ms-8">
						<h3 class="text-base sm:text-lg font-semibold text-green-500">Customizable Settings</h3>
						<p class="mt-1 text-gray-600 dark:text-gray-300">
